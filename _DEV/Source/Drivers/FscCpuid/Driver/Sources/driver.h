#include "FscCpuid.h"
#define DRIVER_NAME					CpuidServiceName
#define DRIVER_DEVICE_NAME			L"\\Device\\FSC_CPUID"
#define DRIVER_LINK_NAME_L			L"\\DosDevices\\FSC_CPUID"
