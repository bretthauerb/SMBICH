...
"%_BUILDTOOLS_%\signtoolwrapper.exe" /basedir "%_BINARIES_ROOT_%" /inpfile ".\Scripts\sign_all_sys.xml" /logfile %_LOGFILEPATH_% /cfgfile "%_BUILDTOOLS_%\ss_xevauth_StWCfg.xml"
