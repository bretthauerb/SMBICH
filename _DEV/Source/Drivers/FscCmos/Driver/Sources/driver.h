#include "FscCmos.h"
#define DRIVER_NAME                 CmosServiceName
#define DRIVER_DEVICE_NAME			L"\\Device\\FSC_CMOS"
#define DRIVER_LINK_NAME_L			L"\\DosDevices\\FSC_CMOS"
...
// Uncomment the following line for having trace output!
// Use DBGLEVEL 0 to output errors only, 1=warning, 2=info
// #define DBGLEVEL 2 

#ifdef DBGLEVEL
#   define DBG_OUT(X,STRING)  { \
        if (X <= DBGLEVEL) DbgPrint STRING; \
	    }
#else
#   define DBG_OUT(X,STRING)
#endif//DBG
