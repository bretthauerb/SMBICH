#include "FscTime.h"
#define DRIVER_NAME					FscTimeServiceName
#define DRIVER_DEVICE_NAME			L"\\Device\\FSC_TIME"
#define DRIVER_LINK_NAME_L			L"\\DosDevices\\FSC_TIME"
